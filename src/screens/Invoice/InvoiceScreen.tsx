...
//   /* ================= Invoice Due (DUMMY DATA) ================= */

//   // const dueInvoices: DueInvoice[] = [
//   //   {
//   //     srNo: '1',
//   //     billNo: '2526-V1-TR-05500',
...
//   // const selectedTotalAmount = dueInvoices
//   //   .filter(inv => selectedInvoices.includes(inv.billNo))
...
//   //     Alert.alert('Select Invoice', 'Please select at least one invoice');
//   //     return;
//   //   }
...
//   //     currency: 'INR',
//   //     key: 'rzp_test_RF1SJeA9BG7ySv', // 🔴 replace with your test key
//   //     amount: selectedTotalAmount * 100, // paise
...
//         {/*
//         <View style={styles.formContainer}>
//           <Text style={styles.sectionTitle}>Invoice Due</Text>

//           <TouchableOpacity
//             style={[
//               styles.button,
//               styles.submitButton,
//               selectedInvoices.length === 0 && styles.disabledButton,
//             ]}
//             onPress={makePayment}
//             disabled={selectedInvoices.length === 0}>
//             <Text style={styles.submitButtonText}>Make Payment</Text>
//             <Text style={styles.dueAmount}>
//               Invoice Due ₹{formatCurrency(selectedTotalAmount)}
//             </Text>
//           </TouchableOpacity>
...
//                   'Status',
//                 ].map((h, i) => (
//                   <View key={i} style={[styles.tableHeaderCell, {width: 120}]}>
...
//                     <TouchableOpacity
//                       onPress={() => toggleInvoice(inv.billNo)}
//                       style={{
//                         width: 18,
//                         height: 18,
//                         borderWidth: 1,
//                         borderColor: '#3498db',
//                         backgroundColor: selectedInvoices.includes(inv.billNo)
//                           ? '#3498db'
//                           : '#fff',
//                       }}
//                     />
...
//                   <View style={[styles.tableCell, {width: 120}]}>
//                     <Text style={styles.billNoText}>{inv.billNo}</Text>
//                   </View>
...
//                   <View style={[styles.tableCell, {width: 120}]}>
//                     <Text>₹{formatCurrency(inv.amount)}</Text>
//                   </View>
...
const FinanceScreen: React.FC = () => {
  ...
  const renderTable = () => {
    ...
    const displayRows =
      viewMode === 'DUE'
        ? filteredRows.map((row, index) => [index + 1, ...row.slice(1)])
        : filteredRows;
